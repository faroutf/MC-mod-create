# ===================================================
# Hard Survival - Daily Quest System
# Load function: initialize scoreboards, task pool, submit tools
# ===================================================
...
# --- Per-slot tracking (8 slots x 4 scoreboards) ---
...
# --- Store task pool definitions (clear first for reload safety) ---
...
# --- Initialize players (new join detection, safe for reload) ---
execute as @a unless entity @s[tag=hs_active] run scoreboard players set @s hs_new 1
...
# --- Tell schedule tick is ready ---
tellraw @a[tag=admin] {"text":"[HardSurvival] 日常任务系统初始化完成","color":"green"}
